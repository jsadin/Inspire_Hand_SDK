...
std::string ConfigLoader::interfacesProfileFromProtocolType(const std::string& protocol_type) {
    ...
    throw std::runtime_error(
        ...
        "\" 推导 ROS 接口机型，请使用以 RH524J1、RH5DG2、RH56F1、RH56H1、RH56DFX、EG5CD1 或 EG2_4C2 为前缀的 "
        "protocol.type（如 RH524J1_485、RH56H1_485、RH56DFX_serial_can、EG5CD1、EG2_4C2_serial_can）");
}
